package main.java.Exercises.OOP.Encapsulation.Exercises;
...
public class Printer {
    ...
    public static void main(String[] args) {
        main.java.Exercises.OOP.Encapsulation.Printer printer = new main.java.Exercises.OOP.Encapsulation.Printer(50, true);
