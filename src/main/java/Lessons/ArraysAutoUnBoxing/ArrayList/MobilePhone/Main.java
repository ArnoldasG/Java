...
public class Main {
    ...
    public static MobilePhone mobilePhone = new MobilePhone("+370 614 444 10");
    ...
    private static void addNewContact() {
        ...
        if(mobilePhone.addNewContact(newContact)) {
            ...
            System.out.println("Cannot add " + name + " because it's already on a file");
        }
    }
